...
- Does the average price of restaurants in a given zip code correlate with median income in that zip code?
...
- Can we map the distribution of the following categories of restaurants?
  - Fast Food
  - Steakhouse
  - Chinese
- Can we map the distribution of expensive restaurants?
