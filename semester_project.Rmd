...
**Warning: You may find that while running this, you get an error with the flatten function. This seems like a somewhat arbitrary issue based on the time you run your query. Simply repeat the knit until it works.** 
```{r}
